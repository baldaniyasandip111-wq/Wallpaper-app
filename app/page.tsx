...
{id:32,title:"Quiet Concrete",cat:"Minimal",url:"https://images.unsplash.com/photo-1494438639946-1ebd1d20bf85?auto=format&fit=crop&w=1200&q=90"},
{id:33,title:"Misty Peaks",cat:"Nature",url:"https://images.unsplash.com/photo-1439565983992-3ee6dd957b9c?auto=format&fit=crop&w=1200&q=90"},
{id:34,title:"City Rain",cat:"City",url:"https://images.unsplash.com/photo-1779911813018-c650877e6d43?auto=format&fit=crop&w=1200&q=90"},
{id:35,title:"Cosmic Violet",cat:"Abstract",url:"https://images.unsplash.com/photo-1751336112082-66c6f90b823b?auto=format&fit=crop&w=1200&q=90"},
{id:36,title:"Soft Geometry",cat:"Minimal",url:"https://images.unsplash.com/photo-1741869218100-42951c3b0568?auto=format&fit=crop&w=1200&q=90"},
{id:37,title:"Forest Light",cat:"Nature",url:"https://images.unsplash.com/photo-1756141259862-ce6caf4777df?auto=format&fit=crop&w=1200&q=90"},
{id:38,title:"Midnight Tower",cat:"City",url:"https://images.unsplash.com/photo-1768006238396-c013c5db2169?auto=format&fit=crop&w=1200&q=90"},
{id:39,title:"Blue Horizon",cat:"Abstract",url:"https://images.unsplash.com/photo-1744024400478-4cae0bcb4663?auto=format&fit=crop&w=1200&q=90"},
{id:40,title:"Quiet Space",cat:"Minimal",url:"https://images.unsplash.com/photo-1745745722251-637138cedc8d?auto=format&fit=crop&w=1200&q=90"}
];
...
<section className="hero"><h1>Find your next wallpaper.</h1><p>40 beautiful wallpapers made for your phone.</p><div className="search"><Search size={22}/><input value={q} onChange={e=>setQ(e.target.value)} placeholder="Search wallpapers..." aria-label="Search wallpapers"/><button onClick={()=>document.querySelector(".grid")?.scrollIntoView({behavior:"smooth"})}>Search</button></div></section>
...
<footer className="footer">© 2026 Wallpaper.app · 40 wallpapers · Made for mobile</footer>
</div>
