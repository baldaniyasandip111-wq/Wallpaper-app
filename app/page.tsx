...
{id:25,title:"Desert Dunes",cat:"Nature",url:"https://images.unsplash.com/photo-1500534623283-312aade485b7?auto=format&fit=crop&w=1200&q=90"},
...
{id:28,title:"Warm Minimal",cat:"Minimal",url:"https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=1200&q=90"},
...
<section className="hero"><h1>Find your next wallpaper.</h1><p>32 beautiful wallpapers made for your phone.</p><div className="search"><Search size={22}/><input value={q} onChange={e=>setQ(e.target.value)} placeholder="Search wallpapers..." aria-label="Search wallpapers"/><button onClick={()=>document.querySelector(".grid")?.scrollIntoView({behavior:"smooth"})}>Search</button></div></section>
